            ...
            <div>
              ...
              <div className="flex items-center gap-4 text-sm">
                <div className="flex items-center gap-1">
                  ...
                  <span className="text-blue-100">({profileData.reviews} reseñas)</span>
                </div>
                <div className="flex items-center gap-1">
                  <CheckCircle className="w-4 h-4" />
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <div className="flex items-center gap-1 mt-1">
                ...
                <span className="text-xs text-gray-600">{profileData.reviews} reseñas</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200">
            <div className="p-6 border-b border-gray-200">
              <div className="flex items-center justify-between">
                <h2 className="text-lg font-semibold text-gray-900">Trabajos Activos</h2>
                <button className="text-blue-600 hover:text-blue-700 text-sm font-medium">
                  Ver historial
                </button>
              </div>
            ...
            <div className="p-6 space-y-4">
              {activeJobs.map((job) => (
                <div key={job.id} className="bg-blue-50 rounded-lg p-4 border border-blue-200">
            ...
            <div className="p-6 space-y-4">
              <button className="w-full flex items-center justify-between p-3 bg-gray-50 hover:bg-gray-100 rounded-lg transition-colors">
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-medium">Editar información personal</span>
                </div>
        ...
        <div className="p-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="text-center p-4 bg-green-50 rounded-lg">
              ...
              <p className="text-lg font-bold text-green-600">${earnings.thisMonth.toLocaleString()}</p>
              <p className="text-sm text-gray-600">Este mes</p>
            </div>
            <div className="text-center p-4 bg-blue-50 rounded-lg">
              <TrendingUp className="w-8 h-8 text-blue-600 mx-auto mb-2" />
              <p className="text-lg font-bold text-blue-600">${earnings.lastMonth.toLocaleString()}</p>
              <p className="text-sm text-gray-600">Mes anterior</p>
            </div>
            <div className="text-center p-4 bg-orange-50 rounded-lg">
              <Clock className="w-8 h-8 text-orange-600 mx-auto mb-2" />
              <p className="text-lg font-bold text-orange-600">${earnings.pending.toLocaleString()}</p>
              <p className="text-sm text-gray-600">Pendiente</p>
            </div>
            <div className="text-center p-4 bg-purple-50 rounded-lg">
              <Award className="w-8 h-8 text-purple-600 mx-auto mb-2" />
              <p className="text-lg font-bold text-purple-600">${earnings.total.toLocaleString()}</p>
