...
export default function ProfessionalAddressCard(props) {
  const { reviews } = props;
  ...
  return (
    <>
      <div className="p-5 dark:border-gray-800 lg:p-2 overflow-hidden">
        <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
          <ReviewsList reviews={[...reviews, ...reviews, ...reviews]} />
