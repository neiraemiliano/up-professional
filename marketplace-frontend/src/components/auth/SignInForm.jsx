  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { setSubmitting, setErrors }) => {
      try {
        ...
        // localStorage.setItem("remember", keepLogged ? "1" : "0");
          ...
          <div>
            ...
            <form onSubmit={formik.handleSubmit}>
              <div className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link
                    to="/reset-password"
                    className="text-sm text-violet-500 hover:text-violet-600 dark:text-violet-400"
                  >
            ...
            <div className="mt-5">
              <p className="text-sm font-normal text-center text-gray-700 dark:text-gray-400 sm:text-start">
                ...
                <Link
                  to="/signup"
                  className="text-violet-500 hover:text-violet-600 dark:text-violet-400 ml-1"
                >
                  {getText("signUp")}
                </Link>
              </p>
