...
const WEBHOOK_SECRET =
  process.env.WEBHOOK_SECRET || "your-webhook-secret-change-this";
...
const server = http.createServer(async (req, res) => {
  ...
  res.setHeader(
    ...
    "Content-Type, X-Hub-Signature-256"
  );
...
server.listen(WEBHOOK_PORT, () => {
  ...
  log(`📍 Webhook URL: http://home-fixed.com:${WEBHOOK_PORT}${WEBHOOK_PATH}`);
  log(`📄 Deploy script: ${DEPLOY_SCRIPT}`);
  log(`📋 Log file: ${LOG_FILE}`);
  console.log("");
  console.log("🔧 Setup instructions:");
  console.log(
    `1. Add webhook in GitHub: http://home-fixed.com:${WEBHOOK_PORT}${WEBHOOK_PATH}`
  );
  console.log(
